...
def buildTree(node, features, classes, currDepth, isRandFeats):
    ...
    if numEgsL <= DTEXAMPLELIMIT:
        ...
        buildTree(node.lChild,tx, classes[remainingEgs], currDepth+1, isRandFeats)
    ...
    if numEgsR <= DTEXAMPLELIMIT:
        ...
        buildTree(node.rChild, tx, classes[remainingEgs], currDepth+1, isRandFeats)
    ...
    if ExploreEnsembleSpace:
        ...
        for counterSizes in range(0,len(percentTraining)):
            ...
            for fold in range(0,numFolds):
                ...
                buildTree(rootNode, featuresTraining, classLabelsTr, 1, 0)
                ...
                for countTree in range(0,RFNUMTREES):
                    ...
                    buildTree(rootNode, featuresTraining, classLabelsTr, 1, 1)
